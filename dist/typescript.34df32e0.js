...
async function renderProductDetails() {
    ...
    const createErrorDiv = (title, message, retry = false)=>{
        ...
        errorDiv.className = "min-h-screen flex items-center justify-center bg-gray-50 dark:bg-gray-900";
        errorDiv.innerHTML = `
      <div class="text-center p-12 bg-white dark:bg-gray-800 rounded-3xl shadow-lg border border-gray-100 dark:border-gray-700 max-w-md">
        ...
        ${retry ? `<button onclick="window.location.reload()" class="px-8 py-3 bg-black text-white rounded-2xl hover:bg-gray-800 dark:hover:bg-gray-700 transition-all duration-300">
                Retry
              </button>` : `<a href="/products" class="inline-block px-8 py-3 bg-black text-white rounded-2xl hover:bg-gray-800 dark:hover:bg-gray-700 transition-all duration-300">
                Browse Products
              </a>`}
      </div>
    `;
    ...
    if (!productId) return createErrorDiv("Product Not Found", "Product ID is missing in URL.");
    try {
    ...
    `;
        ...
        backLink.className = "inline-flex items-center gap-2 text-gray-600 dark:text-gray-300 hover:text-black dark:hover:text-white mb-8 transition-colors duration-300";
        backLink.innerHTML = `
    ...
    `;
        ...
        productCard.className = "bg-white dark:bg-gray-800 rounded-3xl p-8 lg:p-12 card-shadow transition-all duration-500";
        ...
        mainImage.className = "w-full h-96 lg:h-[500px] rounded-2xl object-cover image-hover border border-gray-100 dark:border-gray-700";
        ...
        if (product.images && product.images.length > 1) product.images.slice(0, 4).forEach((imgSrc, index)=>{
            ...
            thumb.className = "w-16 h-16 rounded-xl object-cover cursor-pointer transition-all duration-300 hover:scale-110 border border-gray-200 hover:border-black dark:border-gray-600 dark:hover:border-white";
            thumb.onclick = ()=>{
      ...
      <div class="space-y-6">
        ...
        <div class="space-y-2">
          <div class="flex items-baseline gap-4">
            ...
            ${savings > 0 ? `<span class="text-xl text-gray-400 dark:text-gray-500 line-through">$${originalPrice.toFixed(2)}</span>` : ""}
          </div>
          ${savings > 0 ? `<p class="text-sm text-gray-600 dark:text-gray-400">Save $${savings.toFixed(2)} (${product.discountPercentage.toFixed(0)}% off)</p>` : ""}
        </div>
      </div>
      ...
      <div class="border-t border-gray-100 dark:border-gray-700 pt-8 space-y-6">
        <div class="flex items-center justify-between">
          <div class="flex items-center border border-gray-200 dark:border-gray-600 rounded-xl bg-gray-50 dark:bg-gray-700">
            <button class="quantity-btn px-4 py-3 text-black dark:text-white hover:bg-gray-100 dark:hover:bg-gray-600 transition-colors duration-200 rounded-l-xl" data-action="decrease">\u{2212}</button>
...
},{"../api":"hKNQC","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"aUJjy":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
function createLayout(contentFn) {
    ...
    const header = (0, _navbar.Navbar)();
    const content = contentFn();
    const footer = (0, _footer.Footer)();
    app.append(header, content, footer);
}

},{"./components/Navbar":"40Nkq","./components/Footer":"11wJK","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"40Nkq":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
